...
namespace MDTManagment.Models
{
    public class Order
    {
        ...
        public List<string> SpecialRequirements { get; set; }       // CAN'T ENTER LISTS IN THE DATEBASE??????????????????????????????????????????????@!@?!@?!@
                                                                    // CAN'T ENTER LISTS IN THE DATEBASE??????????????????????????????????????????????@!@?!@?!@
        public List<string> DeclaredIngredients { get; set; }       // CAN'T ENTER LISTS IN THE DATEBASE??????????????????????????????????????????????@!@?!@?!@
